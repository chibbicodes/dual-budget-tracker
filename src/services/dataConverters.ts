...
export function convertDbIncomeSource(dbIncomeSource: any): IncomeSource {
  return {
    ...
    firstOccurrenceAmount: dbIncomeSource.first_occurrence_amount || undefined,
    frequency: dbIncomeSource.frequency,
    nextExpectedDate: dbIncomeSource.next_expected_date,
    endCondition: dbIncomeSource.end_condition || 'none',
    endDate: dbIncomeSource.end_date || undefined,
    totalOccurrences: dbIncomeSource.total_occurrences || undefined,
